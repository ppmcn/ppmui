...
```html
<a class="button button-blue button-smaller">超小</a>
<a class="button button-blue button-small">小按钮</a>
<a class="button button-blue">正常大小</a>
<a class="button button-blue button-large">大按钮</a>
<a class="button button-blue button-larger">很大的按钮</a>
```
